...
TASK_RELATED_OBJECT_NAMES = ["door_handle", "door_right", "j2n6s300_hand", "j2n6s300_finger"]

_visibility_views, _visibility_views_dict = surrounding_view(point=np.array([0.1, 0.2, 0.3]), radius=0.6)
