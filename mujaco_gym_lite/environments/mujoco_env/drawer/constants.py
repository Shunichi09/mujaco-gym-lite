...
TASK_RELATED_OBJECT_NAMES = ["drawer_handle", "j2n6s300_hand", "j2n6s300_finger", "drawer_front"]

_visibility_views, _visibility_views_dict = surrounding_view(point=np.array([0.1, -0.08, 0.125]), radius=0.6)
