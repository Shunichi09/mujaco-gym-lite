...
TASK_RELATED_OBJECT_NAMES = ["hinged_box_handle", "j2n6s300_hand", "j2n6s300_finger"]

_visibility_views, _visibility_views_dict = surrounding_view(point=np.array([0.005, 0.09, 0.15]), radius=0.75)
