...
TASK_RELATED_OBJECT_NAMES = ["soccer_ball", "j2n6s300_hand", "j2n6s300_finger"]

_visibility_views, _visibility_views_dict = surrounding_view(point=np.array([-0.3, 0.0, 0.05]), radius=0.75)
